...
Fixpoint close_dexp_wrt_dexp_rec (n1 : nat) (x1 : var) (ee1 : dexp) {struct ee1} : dexp :=
  match ee1 with
    ...
    | de_ann ee2 A1 => de_ann (close_dexp_wrt_dexp_rec n1 x1 ee2) A1
...
Fixpoint size_dexp (ee1 : dexp) {struct ee1} : nat :=
  match ee1 with
    ...
    | de_ann ee2 A1 => 1 + (size_dexp ee2) + (size_typ A1)
...
Inductive degree_dexp_wrt_dexp : nat -> dexp -> Prop :=
  ...
  | degree_wrt_dexp_de_ann : forall n1 ee1 A1,
    degree_dexp_wrt_dexp n1 ee1 ->
    degree_dexp_wrt_dexp n1 (de_ann ee1 A1)
...
Inductive lc_set_dexp : dexp -> Set :=
  ...
  | lc_set_de_ann : forall ee1 A1,
    lc_set_dexp ee1 ->
    lc_set_dexp (de_ann ee1 A1)
